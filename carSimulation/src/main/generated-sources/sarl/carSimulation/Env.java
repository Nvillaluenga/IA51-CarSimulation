...
public class Env extends Agent {
  ...
  @Inject
  @Deprecated
  public Env(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public Env(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
